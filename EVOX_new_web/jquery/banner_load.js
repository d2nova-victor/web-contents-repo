  $(document).ready(function(){
     var pathname = window.location.pathname;
      ...
      var bannertop = bannertop + navtop3;
              if(location.pathname == "/tw/contact-us" || location.pathname == "/tw/pricing" || location.pathname == "/tw/solutions/teleworking" || location.pathname == "/tw/submit-ticket/"){
                $("#bannerloading").html("");
                // 非不得已，修改聯絡我們沒有banner
                $("#header").css("top","0px");
              ...
              // }
                 ...
                 window.onscroll = function() {scrollFunction();};
                $("#bannerloading").html("<div id='navbar' class='web-notification-banner'><p>EVOX 如何幫助企業實行遠距工作？<a class='' href='/tw/solutions/teleworking'>了解更多  </a> </p></div>");
