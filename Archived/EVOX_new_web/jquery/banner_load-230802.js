  $(document).ready(function(){
     var pathname = window.location.pathname;
      ...
      var bannertop = bannertop + navtop3;
              if(location.pathname == "/tw/contact-us" || location.pathname == "/tw/pricing" || location.pathname == "/tw/solutions/digital-transformation" || location.pathname == "/tw/submit-ticket/" || location.pathname == "/tw/number-trust-by-evox-whoscall"){
                $("#bannerloading").html("");
                // 非不得已，修改聯絡我們沒有banner
                $("#header").css("top","0px");
